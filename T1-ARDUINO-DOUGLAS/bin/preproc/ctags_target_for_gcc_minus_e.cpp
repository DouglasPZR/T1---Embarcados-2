# 1 "c:\\Users\\dougl\\Google Drive\\Faculdade\\GitHub\\Embarcados II\\Trabalho 1 - Douglas P Rodrigues\\T1---Embarcados-2\\T1-ARDUINO-DOUGLAS\\T1-ARDUINO-DOUGLAS.ino"



//------------------------------------------------------------------------------------------ BIBLIOTECAS
# 6 "c:\\Users\\dougl\\Google Drive\\Faculdade\\GitHub\\Embarcados II\\Trabalho 1 - Douglas P Rodrigues\\T1---Embarcados-2\\T1-ARDUINO-DOUGLAS\\T1-ARDUINO-DOUGLAS.ino" 2
# 7 "c:\\Users\\dougl\\Google Drive\\Faculdade\\GitHub\\Embarcados II\\Trabalho 1 - Douglas P Rodrigues\\T1---Embarcados-2\\T1-ARDUINO-DOUGLAS\\T1-ARDUINO-DOUGLAS.ino" 2
# 8 "c:\\Users\\dougl\\Google Drive\\Faculdade\\GitHub\\Embarcados II\\Trabalho 1 - Douglas P Rodrigues\\T1---Embarcados-2\\T1-ARDUINO-DOUGLAS\\T1-ARDUINO-DOUGLAS.ino" 2
...
DHT dht(10, 11 /**< DHT TYPE 11 */ /* DHT 11*/);
...
void ACIONA_LEDS (uint8_t comando_LEDS){
  if (comando_LEDS & (1<<0)) digitalWrite(6, 0x1);
  else digitalWrite(6, 0x0);
  if (comando_LEDS & (1<<1)) digitalWrite(7, 0x1);
  else digitalWrite(7, 0x0);
  if (comando_LEDS & (1<<2)) digitalWrite(8, 0x1);
  else digitalWrite(8, 0x0);
  if (comando_LEDS & (1<<3)) digitalWrite(9, 0x1);
  else digitalWrite(9, 0x0);
}
...
//resposta modbus p/ slave
      ...
      vetor_resposta_modbus [3] = ((digitalRead(A3) << 3) |(digitalRead(A2) << 2) | (digitalRead(A1) << 1) | (digitalRead(A0) << 0));
